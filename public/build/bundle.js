...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 85, 3, 2209);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(85:3) {#each row as cell, k}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 83, 2, 2160);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(83:1) {#each grid as row, i}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 81, 0, 2125);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function randomFood() {
    		$$invalidate(0, grid[Math.floor(Math.random() * gridSize)][Math.floor(Math.random() * gridSize)] = 'food', grid);
    		$$invalidate(0, grid[Math.floor(Math.random() * gridSize)][Math.floor(Math.random() * gridSize)] = 'food', grid);
    	}
    	...
    	const fn = n => {
    		setTimeout(
    			() => {
    				...
    				handleTile(nextPos);
    				$$invalidate(0, grid[nextPos[0]][nextPos[1]] = 'snake', grid);

    				if (snakes.length > length) {
    					let delSnake = snakes.pop();
    					$$invalidate(0, grid[delSnake[0]][delSnake[1]] = 'empty', grid);
    				}
